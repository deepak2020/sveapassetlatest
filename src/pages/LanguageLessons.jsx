...
const SFI_COURSES = [
  {
    ...
    description: "Master Swedish sounds, basic survival phrases, and fundamental concepts of Swedish democracy.",
    color: "from-emerald-400 to-teal-500",
    bg: "bg-emerald-50 dark:bg-emerald-900/20",
    border: "border-emerald-200 dark:border-emerald-800",
    badge: "bg-emerald-100 text-emerald-800 dark:bg-emerald-900 dark:text-emerald-200",
    level: "beginner",
    topics: ["Hard & Soft Vowels", "Numbers & Money", "Basic Democracy", "Greetings", "Public Safety (112)", "Family & Home"],
  },
  {
    id: "B",
    name: "Course B: Daily Life",
    subtitle: "Beginner",
    description: "Build your independence by learning to navigate shopping, healthcare, and the essential V2 word-order rule.",
    color: "from-blue-400 to-indigo-500",
    bg: "bg-blue-50 dark:bg-blue-900/20",
    border: "border-blue-200 dark:border-blue-800",
    badge: "bg-blue-100 text-blue-800 dark:bg-blue-900 dark:text-blue-200",
    level: "beginner",
    topics: ["V2 Word Order", "Nature & Allemansrätten", "Shopping & Units", "Healthcare (Vårdcentral)", "Daily Routines", "Past Tense"],
  },
  {
    id: "C",
    name: "Course C: Integration",
    subtitle: "Intermediate",
    description: "Professional Swedish for the workplace, understanding labor rights, and engaging with national news media.",
    color: "from-violet-400 to-purple-500",
    bg: "bg-violet-50 dark:bg-violet-900/20",
    border: "border-violet-200 dark:border-violet-800",
    badge: "bg-violet-100 text-violet-800 dark:bg-violet-900 dark:text-violet-200",
    level: "intermediate",
    topics: ["Workplace Fika Culture", "Unions & Rights", "Sustainability", "Media Literacy", "Gender Equality", "Complex Conjunctions"],
  },
  {
    id: "D",
    name: "Course D: Citizenship",
    subtitle: "Advanced",
    description: "Deep dive into Swedish history, the constitution, and academic Swedish to prepare for the official citizenship test.",
    color: "from-orange-400 to-red-500",
    bg: "bg-orange-50 dark:bg-orange-900/20",
    border: "border-orange-200 dark:border-orange-800",
    badge: "bg-orange-100 text-orange-800 dark:bg-orange-900 dark:text-orange-200",
    level: "advanced",
    topics: ["Swedish History", "The Constitution", "Legal System", "Academic Reading", "Formal Debate", "Citizenship Simulation"],
  },
];
...
const SKILL_FILTERS = [
  ...
  { key: "civics", emoji: "⚖️", label: "Civic Knowledge" },
