...
// Enrich every Kurs A lesson by sharing vocab + quiz across the 5 skill lessons
// of each topic. Keeps each lesson's primary skill, just adds extra activities.
Deno.serve(async (req) => {
  try {
    ...
    for (const topic of Object.keys(byTopic)) {
      ...
      // Aggregate everything available in this topic
      ...
      // Cap sizes so lessons stay focused
      ...
      for (const l of lessons) {
        ...
        // Always give every lesson vocab cards & a quiz
